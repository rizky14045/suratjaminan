...
class VisaController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $perPage = 25;
        $data['visas'] = Visa::where('rangking','!=',1)
        ->orderBy('rangking', 'asc')
        ->latest()->paginate($perPage);

        return view('mkad.visa.index', $data);
    ...
    public function create()
    {
        ...
        return view('mkad.visa.create',$data);
    }
    ...
    public function show($id)
    {
        ...
        return view('mkad.visa.show', compact('record','keluargas'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('mkad.visa.edit', $data);
    }
    ...
    public function showPDF($id)
    {
        ...
        return $data_pdf= PDF::loadView('mkad/visa/pdf',compact(['visa','sm','keluargas']))->setPaper('a4', 'portrait')->stream();
    ...
    public function approve($id)
    {
        $visa = Visa::findOrFail($id);
        $visa->rangking = 3;
        $visa->status = 'Menunggu Persetujuan Senior Manager';
        $visa->save();

...
class SuratKeteranganController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('mkad.surat-keterangan.index', $data);

    }
    public function create()
    {
        return view('mkad.form-jaminan.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('mkad/surat-keterangan');
    }
    ...
    public function edit($id)
    {
        ...
        return view('mkad.surat-keterangan.edit', $data);
    }
    ...
    public function showPDF($id)
    {
        ...
        return $data_pdf= PDF::loadView('mkad/surat-keterangan/pdf',compact(['suratketerangan','sm']))->setPaper('a4', 'portrait')->stream();
    }

    public function approve($id)
    {
        $suratketerangan = Suratketerangan::findOrFail($id);
        $suratketerangan->rangking = 3;
        $suratketerangan->status = 'Menunggu Persetujuan Senior Manager';
        $suratketerangan->save();
    ...
    public function show_dashboard($id)
    {
        ...
        return view('mkad.form-jaminan.show_dashboard', compact('formjaminan'));
    }
}

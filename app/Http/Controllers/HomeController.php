    ...
    public function json(){
        ...
        foreach ($json_data as $item){
            ...
            Karyawan::create([
                    ...
                    'tgl_lahir_istri' => $item['tgl_lahir_istri'] == '0000-00-00' ? null : $item['tgl_lahir_istri'],
                    'tgl_lahir_anak_1' => $item['tgl_lahir_anak_1']== '0000-00-00' ? null : $item['tgl_lahir_anak_1'],
                    'tgl_lahir_anak_2' => $item['tgl_lahir_anak_2']== '0000-00-00' ? null : $item['tgl_lahir_anak_2'] ,
                    'tgl_lahir_anak_3' => $item['tgl_lahir_anak_3']== '0000-00-00' ? null : $item['tgl_lahir_anak_3'],
                    'email' => $item['email'],

                            ...
                            <div class="header-menu-list d-flex bg-white rt_nav_header horizontal-layout nav-bottom">
                                <div class="append mr-auto my-0 my-md-0 mr-auto">
                                    <ul class="list-group list-group-horizontal-md mr-auto">
                                        <li class="mr-1 {{request()->segment(1) == 'asman' && request()->segment(2) == null ? 'active' : ''}}">
                                            <a href="{{ url('asman') }}"
                                        ...
                                        <li class="mr-1 {{request()->segment(1) == 'asman' && request()->segment(2) == 'form-jaminan' || request()->segment(2) == 'form-jaminan-pensiunan' ? 'active' : ''}}">
                                            <a href="{{ url('asman/form-jaminan') }}"
                                                class="btn-ctm-space text-dark header_class"><span
                                                    class="fa fa-list pr-0 pr-lg-2"></span><span
                                                    class="d-none d-lg-inline">Form Jaminan</span>
                                            </a>
                                        </li>
                                        <li class="mr-1 {{request()->segment(1) == 'asman' && request()->segment(2) == 'ubah-password' ? 'active' : ''}}">
                                            <a href="{{ url('asman/ubah-password') }}"
                                                class="btn-ctm-space text-dark header_class"><span
                                                    class="fa fa-key pr-0 pr-lg-2"></span><span
                                                    class="d-none d-lg-inline">Ubah Password</span>
                                            </a>
                                        </li>
                                        <li class="mr-1 {{request()->segment(1) == 'asman' && request()->segment(2) =='surat-keterangan' || request()->segment(2) =='visa' ? 'active' : ''}}">
                                            <a href="{{ url('asman/surat-keterangan') }}"
                                                class="btn-ctm-space text-dark header_class"><span

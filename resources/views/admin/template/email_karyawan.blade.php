                                                ...
                                                <div
                                                    ...
                                                    <p
                                                        ...
                                                        <span style="font-size: 20px;">
                                                            <strong>
                                                                <span style="font-size: 20px;">Halo Karyawan
                                                                    {{ $formjaminan->karyawan->nama_karyawan }}</span>
                                                            </strong>
                                                        </span>
                                                        <br />
                                                        <span style="font-size: 20px;">Pengajuan Surat Jaminan Anda Sudah Disetujui MKAD</span>
                                                    </p>
                                                </div>
                                            </div>
                                            <div

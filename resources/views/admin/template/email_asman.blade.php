...
<body class="clean-body" style="margin: 0; padding: 0; -webkit-text-size-adjust: 100%; background-color: #046aaa;">
    <table bgcolor="#046aaa" cellpadding="0" cellspacing="0" class="nl-container" role="presentation"
        style="table-layout: fixed; vertical-align: top; min-width: 320px; border-spacing: 0; border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #046aaa; width: 100%;"
                                    ...
                                    <div class="col_cont" style="width:100% !important;">
                                        <div
                                            ...
                                            <div align="center" class="img-container center"
                                                style="padding-right: 0px;padding-left: 0px;">
                                                <img align="center" alt="Image" border="0" class="center"
                                                    src="{{ asset('vendor/lakers/img/logo-pjb.png') }}"
                                        ...
                                        <div
                                                ...
                                                <div
                                                    ...
                                                    <p
                                                        ...
                                                        <span style="font-size: 20px;">
                                                            <strong>
                                                                <span style="font-size: 20px;">Halo Asisten Manager
                                                                    {{ $asman[0]['name'] }}</span>
                                                            </strong>
                                                        </span>
                                                        <br />
                                                        <span style="font-size: 20px;">Ada pengajuan surat jaminan
                                                            kesehatan</span>
                                                    </p>
                                                </div>
                                            </div>
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <p
                                                        style="font-size: 14px; line-height: 1.5; text-align: center; word-break: break-word; mso-line-height-alt: 21px; margin: 0;">
                                                        Berikut Informasi singkat pengajuan surat jaminan kesehatan :

                                                        <br />
                                                        <span style="color: #000000;">NAMA</span> :

                                                        <span style="font-size: 14px; color: #046aaa;">
                                                            <strong>{{ $data_karyawan['karyawan']['nama_karyawan'] }}</strong>
                                                        </span>
                                                        <span style="color: #a8bf6f; font-size: 14px;">
                                                            <strong>
                                                                <br />
                                                            </strong>
                                                        </span>
                                                    ...
                                                    <p
                                                        ...
                                                        <span style="font-size: 14px; color: #046aaa;">
                                                            <strong>
                                                                <span style="color: #000000;">NID</span>
                                                                <span style="color: #000000;">:</span>
                                                                {{ $data_karyawan['karyawan']['nid'] }}
                                                    ...
                                                    <p
                                                        ...
                                                        <span style="font-size: 14px; color: #046aaa;">
                                                            <strong>
                                                                <span style="color: #000000;">NAMA PASIEN</span>
                                                                <span style="color: #000000;">:</span>
                                                                {{ $data_karyawan['nama_pasien'] }}
                                                    ...
                                                    <p
                                                        ...
                                                        <span style="font-size: 14px; color: #046aaa;">
                                                            <strong>
                                                                <span style="color: #000000;">JABATAN</span>
                                                                <span style="color: #046aaa;"> :
                                                                    {{ $data_karyawan['karyawan']['jabatan'] }}</span>
                                                            </strong>
                                                        </span>
                                                    </p>
                                                </div>
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <p
                                                        style="font-size: 14px; line-height: 1.5; text-align: center; word-break: break-word; mso-line-height-alt: 21px; margin: 0;">
                                                        Untuk melihat detail pengajuan, silahkan klik tombol di bawah
                                                        ini</p>
                                                </div>
                                            </div>
                                            <div align="center" class="button-container"
                                                ...
                                                <div
                                                    style="text-decoration:none;display:inline-block;color:#ffffff;background-color:#046aaa;border-radius:4px;-webkit-border-radius:4px;-moz-border-radius:4px;width:auto; width:auto;;border-top:1px solid #046aaa;border-right:1px solid #046aaa;border-bottom:1px solid #046aaa;border-left:1px solid #046aaa;padding-top:15px;padding-bottom:15px;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;text-align:center;mso-border-alt:none;word-break:keep-all;">
                                                    <span
                                                        style="padding-left:15px;padding-right:15px;font-size:16px;display:inline-block;">
                                                        <span
                                                            style="font-size: 16px; line-height: 2; word-break: break-word; mso-line-height-alt: 32px;"><a
                                                                href="{{ url('form-jaminans/' . $data_karyawan['id']) }}"
                                                                target="_blank">LIHAT SURAT PENGAJUAN</a></span>
                                                    </span>
                                                </div>
                                            </div>

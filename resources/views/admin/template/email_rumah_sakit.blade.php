                                                ...
                                                <div
                                                    ...
                                                    <p
                                                        ...
                                                        <span style="font-size: 20px;">
                                                            <strong>
                                                                <span style="font-size: 20px;">Halo 
                                                                    {{ $formjaminan['rumahsakit']['nama_rumah_sakit'] }}</span>
                                                            </strong>
                                                        </span>
                                                        <br />
                                                        <span style="font-size: 20px;">Dengan Informasi Di bawah ini , informasi Karyawan Telah Disetujui oleh Kami</span>
                                                    </p>
                                                </div>
                                            </div>
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <p
                                                        style="font-size: 14px; line-height: 1.5; text-align: center; word-break: break-word; mso-line-height-alt: 21px; margin: 0;">
                                                        Berikut Informasi singkat surat jaminan kesehatan :

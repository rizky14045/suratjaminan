                                                ...
                                                <div
                                                    ...
                                                    <p
                                                        ...
                                                        <span style="font-size: 20px;">
                                                            <strong>
                                                                <span style="font-size: 20px;">Halo MKAD
                                                                    {{ $mkad[0]['name'] }}</span>
                                                            </strong>
                                                        </span>
                                                        <br />
                                                ...
                                                <div
                                                    ...
                                                    <p
                                                        ...
                                                        <span style="font-size: 14px; color: #046aaa;">
                                                            <strong>{{ $formjaminan->karyawan->nama_karyawan }}</strong>
                                                        </span>
                                                        ...
                                                        <span style="font-size: 14px; color: #046aaa;">
                                                            <strong>
                                                                ...
                                                                <span style="color: #046aaa;"> :
                                                                    {{ $formjaminan->karyawan->jabatan }}</span>
                                                            </strong>
                                                        </span>
                                                    </p>
                                                </div>
                                                    ...
                                                    <span
                                                        ...
                                                        <span
                                                            style="font-size: 16px; line-height: 2; word-break: break-word; mso-line-height-alt: 32px;"><a
                                                                href="{{ url('form-jaminans/' . $formjaminan->id) }}"

...
<body>
    ...
    <div class="penjelasan">
        ...
        <p>Untuk koordinasi terkait diagnosa dan rencana tindakan yang akan di berikan kepada pasien, dapat menghubungi Dokter Perusahaan, yaitu dr. Alex / dr. Aji ( No. HP : 0813-1487-9198 ). untuk informasi lebih lanjut terkait administrasi jaminan perawatan kesehatan, dapat menghubungi contact person : Sdr . I Gusti Ngurah Bartha ( HP : 082230920005) / Sdr, Nasir (HP : 081281121064) dan juga dapat melakukan koordinasi kepada Assistant Manager SDM, Umum & CSR UP Muara Karang (Ibu Sarika Apriyeni Gopar).</p>
    ...
    <div class="ttd">
        ...
        <div class=">paraf" style="margin-top:-30px;">
        ...
        <span class="ttd-nama" style="margin-top:-25px;">{{ $sm[0]['name'] }}</span>
        <div class=">paraf" style="margin-top:-30px;">
            <img src="{{public_path('qrcode/asman.png')}}" alt="" width="30">
        </div>
        @endif

                            ...
                            <div class="card-body">
                                <ul class="list-group">
                                    ...
                                    <li class="list-group-item text-center button-1"><a
                                            href="{{ url('/mkad/visa') }}" class="text-white">Visa</a></li>
                                </ul>
                            </div>
                        </div>
                    </aside>
                                                ...
                                                <tbody>
                                                    @foreach ($surats as $i => $item)
                                                        <tr class={{$item->rangking == 2 ? 'bg-danger' :''}}>
                                                            ...
                                                            <td class="text-ck {{$item->rangking == 2 ? 'text-white' :''}}">{{ $item->penerima }}</td>
                                                            <td class="text-ck {{$item->rangking == 2 ? 'text-white' :''}}">{{ $item->alamat_penerima }}</td>
                                                            ...
                                                            <td class="text-right" align="center">
                                                                <div class="table-action">
                                                                    <a href="{{ url('/mkad/surat-keterangan/pdf/' . $item->id) }}"
                                                                    ...
                                                                    @if ($item->rangking == 2)
                                                                        ...
                                                                        <a href="{{ url('/mkad/surat-keterangan/approve/' . $item->id) }}"

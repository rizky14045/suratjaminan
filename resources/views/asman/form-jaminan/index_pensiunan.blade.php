                            ...
                            <div class="card-body">
                                <ul class="list-group">
                                    <li class="list-group-item text-center button-1"><a
                                            href="{{ url('/asman/form-jaminan') }}" class="text-white">Karyawan</a>
                                    </li>
                                    <li class="list-group-item text-center button-1"><a
                                            href="{{ url('/asman/form-jaminan-pensiunan') }}"
                                                            ...
                                                            <tr class="{{$item->rangking == 2 ? 'bg-danger' :''}}">
                                                                ...
                                                                <td class="text-right" align="center">
                                                                    <div class="table-action">
                                                                        ...
                                                                        <a href="{{ url('/asman/show-pdf/' . $item->id) }}"
                                                                            title="View FormJaminan" target="_blank">
                                                                        ...
                                                                        @if($item->rangking == 2 )
                                                                        <a href="{{ url('/asman/form-jaminan/approve/' . $item->id) }}"
